...
@RestController
@RequestMapping("/api/micro-gemp-kafka")
public class MicroGempKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MicroGempKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MicroGempKafkaResource(KafkaProperties kafkaProperties) {
